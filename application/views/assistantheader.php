        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="sidebar-menu">
            <li class="header">MAIN NAVIGATION</li>
              <li class="treeview">
                <a href="<?php echo site_url();?>/AssistantController/add_report">
                  <i class="fa fa-laptop"></i>
                  <span>Create Report</span>
                </a>
              </li>
              <li class="treeview">
                <button type="button" class="fa fa-laptop" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"><span>Create Report</span></button>
              </li>
          </ul>
        </div>
          <!-- /.navbar-collapse -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="type" class="col-form-label">Device Type:</label>
          ...
          <div class="form-group">
            <label for="id" class="col-form-label">Item No:</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" onclick="<?php echo site_url();?>/AssistantController/report/">Send Report</button>
      </div>
    </div>
  </div>
</div>