	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
        ...
        <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span>IT ASSET<span class="dashboard_text">dashboard</span></a></h1>
          </div>
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="grids.html"><i class="fa fa-angle-right"></i>SOFTWARE</a></li>
                  <li><a href="media.html"><i class="fa fa-angle-right"></i>HARDWARE</a></li>
				  <li><a href="media.html"><i class="fa fa-angle-right"></i>OPERATING SYSTEM</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.html">
