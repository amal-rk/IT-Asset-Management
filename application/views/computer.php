<?php include 'header.php'; ?>
		...
		<div id="page-wrapper">
      <div class="row">
      	<form class="form-horizontal" action="<?php echo site_url();?>/AdminController/add_computer/" method="post">
					<h3 class="title1">ADD COMPUTER :</h3>
					<div class="form-three widget-shadow">
						<div class="form-group">
							<label for="devicename" class="col-sm-2 control-label">Device Name</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="devicename">
							</div>
						</div>
						<div class="form-group">
							<label for="manufacture" class="col-sm-2 control-label">Manufacturer</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="processor">
							</div>
						</div>
						<div class="form-group">
							<label for="ram" class="col-sm-2 control-label">RAM</label>
							<div class="col-sm-8">
								<input  type="text" class="form-control1" name="ram">
							</div>
						</div>
						<div class="form-group">
							<label for="drive" class="col-sm-2 control-label">Drive Capacity</label>
							<div class="col-sm-8">
								<input  type="text" class="form-control1" name="drive">
							</div>
						</div>
            			<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea cols="50" rows="4" class="form-control1" name="description"></textarea>
							</div>
						</div>
					</div>
					<div class="row">
