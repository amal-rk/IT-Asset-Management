      ...
      <div class="row">
      	<form class="form-horizontal" action="<?php echo site_url();?>/AdminController/add_software/" method="post">
					...
					<div class="form-three widget-shadow">
						...
						<div class="form-group">
							<label for="version" class="col-sm-2 control-label">Version/Edition</label>
							<div class="col-sm-8">
								<input  type="text" class="form-control1" name="version">
							</div>
						</div>
						<div class="form-group">
							<label for="systemid" class="col-sm-2 control-label">System No</label>
							<div class="col-sm-8">
								<input  type="number" class="form-control1" name="systemid">
							</div>
						</div>
						<div class="form-group">
							<label for="installdate" class="col-sm-2 control-label">Installation Date</label>
							<div class="col-sm-8">
								<input type="date" class="form-control1" name="installdate">
							</div>
						</div>
						<div class="form-group">
							<label for="type" class="col-sm-2 control-label">Software Type</label>
							<div class="col-sm-8">
					...
					<div class="form-three widget-shadow">
						<div class="form-group">
							<label for="price" class="col-sm-2 control-label">Price ( ignore for free software )</label>
							<div class="col-sm-8">
